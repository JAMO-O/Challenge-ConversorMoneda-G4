...
public class Select  extends JFrame implements ActionListener, ItemListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == boton1 ){
            if(texto == "conversion de mx a monedas"){
                Select2 formulario3= new Select2("mx a dolar","mx a euros","mx a libras esterlinas","mx a yen japones", "mx a won sur-coreano","conversion de mx a monedas");
            ...
            if(texto == "conversion de monedas a mx"){
                Select2 formulario2= new Select2("dolar a mx","euros a mx","libras esterlinas a mx","yen japones a mx","won sur-coreano a mx","conversion de monedas a mx");
